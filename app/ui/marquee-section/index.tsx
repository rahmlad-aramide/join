  ...
  return (
    ...
    >
      <div className="flex flex-col w-full md:w-[45%] items-center justify-center py-10 md:py-[100px]">
        <h2 className="text-center text-3xl sm:text-4xl md:text-5xl text-white font-bold mb-[60px] w-full max-w-[12ch]">
      ...
      <div className="flex items-center justify-center w-full md:w-[55%]">
        <Image
          ...
          width={400}
          height={390}
          alt="Two 3D Join tokens placed on top of each other"
          className="animate-bounce-token scale-90 md:scale-100"
        />
      </div>
    </section>
  );
