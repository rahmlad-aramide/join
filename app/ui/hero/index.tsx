...
export const Hero = () => {
  return (
    <VideoBackground as="section" height="screen" variant="hero">
      <div className="w-[calc(100%_-_32px)] sm:w-[calc(100%_-_64px)] md:w-[calc(100%_-_100px)] xl:w-[calc(100%_-_160px)] max-w-8xl mx-auto flex flex-col items-center pt-24 md:pt-0">
        ...
        <p
          className={`flex w-full max-w-[850px] mx-auto text-center font-medium text-sm md:text-xl leading-[30px] md:leading-[35px] text-white mb-[55px] ${inter.className}`}
        >
