  ...
  return (
    <VideoBackground as="section">
      ...
      <div className="w-[calc(100%_-_32px)] sm:w-[calc(100%_-_64px)] md:w-[calc(100%_-_100px)] xl:w-[calc(100%_-_160px)] max-w-8xl mx-auto flex flex-col items-center pt-24">
        ...
        <Countdown targetDate="2024-08-11T00:00:00" />
        <Button variant="shaped-gradient-outline" disabled={true}><span className="silver-button-gradient font-semibold text-base">Join Whitelisting</span></Button>
      </div>
